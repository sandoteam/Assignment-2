/* program to change one word to an other word of same size by changing a character by character 
and make a comparition for every change and see if the obtained word exist in the dictionary.  */
...
void getWords(string &word1, string &word2) {
  while (true) {
    cout << "Enter word to be transformed: ";
    cin>>word1;
...
void printWordLadder(string word1, string word2){
    ...
    if(dictionary.is_open()) {
      ...
      cerr << "Not found in the dictionary" << endl;
    }
